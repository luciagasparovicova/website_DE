...
- Analysed qualitative data with content analysis (in MaxQDA). Then, wrote a research report based on the aforementioned analysis on the experiences nurses from various nursing institutions have with elderly migrants and what aid they wish for to care better for elderly migrants. 
...
- Collected, prepared, analysed and visualized clinical data (in SPSS and R Studio). 
...
- Performed various organisational tasks at the department, including minute-taking, guideline creation and psychosocial support for several patients' administrative work.  
